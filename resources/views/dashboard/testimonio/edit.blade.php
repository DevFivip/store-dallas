        ...
        <div class="row justify-content-center">
            <div class="col-md-8">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form action="{{ route('testimonio.update', $testimonio->id) }}" method="POST"
                            ...
                            <div class="text-center"
                                ...
                                <img src="{{ url('storage/') }}/{{ $testimonio->imagen }}" id="preview"
                                    class="img-thumbnail" style="height: 150px;">
                            </div>

                            <div class="form-group">
                                <label for="title">Nombre</label>
                                <input type="text" name="title" class="form-control" value="{{ $testimonio->title }}">
                            </div>
                            ...
                            <div class=" form-group">
                                ...
                                <textarea class="form-control" name="descripcion" id=""
                                    rows="10">{{ $testimonio->descripcion }}</textarea>
                            </div>
