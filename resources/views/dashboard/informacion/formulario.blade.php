                ...
                <div class="card-body">
                    <form action="{{ route('informacion.update', 1) }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="empresa_nombre" class="form-control" value="{{ $info['empresa_nombre'] }}">
                        </div>

                        <div class="form-group">
                            <label for="direccion">Direccion de la Empresa</label>
                            <input type="text" name="direccion" class="form-control" value="{{ $info['direccion'] }}">
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="telefono2" class="form-control" value="{{ $info['telefono2'] }}">
                        </div>
                        ...
                        <div class=" form-group">
                            ...
                            <textarea class="form-control" name="descripcion" id="" rows="10">{{ $info['empresa_descripcion'] }}</textarea>
                        </div>
                        ...
                        <div class="form-group mt-2">
                            ...
                            <div class="text-center mt-4" style="height: 250px; width:250px; display: block; margin-left: auto; margin-right: auto;">
                                <img src="{{ url('storage/') }}/{{ $info['logo'] }}" id="preview" class="img-thumbnail">
                            </div>
